...
export const initialReport: CACReport = {
  ...
  diagnostico: {
    ...
    grado_diferenciacion: '', estadificacion_tnm: '', fecha_estadificacion_tnm: '',
    her2_realizado: '98', fecha_her2: '1845-01-01', resultado_her2: '98',
    estadificacion_dukes: '98', ann_arbor_lugano: '98', gleason: '98',
    clasificacion_riesgo: '98', objetivo_inicial: '', objetivo_periodo: '',
